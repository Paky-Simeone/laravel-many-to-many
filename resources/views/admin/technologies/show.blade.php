...
<div class="container mt-4">
    ...
    <a href="{{route('admin.technologies.index')}}" class="btn btn-primary my-3 fs-4">Torna alla lista</a>

    <h2 class="card-title fs-1 my-3">{{$technology->label}}</h2>

    <p class="my-3">{!!$technology->getBadge()!!}</p>


    @if(auth()->user()->role == 'admin')
    <ul class="d-flex mt-4">
        <li>
            <a href="{{route('admin.technologies.edit', $technology)}}" class="m2-3"><i class="fa-solid link-primary fa-pencil fa-xl me-3"></i></a>

        </li>
        <li>
            <button type="button" class="btn btn-link p-0" data-bs-toggle="modal" data-bs-target="#technology-{{$technology->id}}">
